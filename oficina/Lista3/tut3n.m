...
sound(x,fs);    % reproduz entrada x na frq amostragem fs
pause;          % aguarda qq tecla na linha de comando
sound(y,fs);    % reproduz saida filtrada y

% gera um arquivo de saida; nao substituira o arquivo existente
